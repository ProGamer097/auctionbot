...
log_channel = int(-1002083898719)
post_channel = int(-1002083898719)
scammer_channel = int(-1002083898719)
reject_channel = int(-1002083898719)
approve_channel = int(-1002083898719)
START_CAPTION = str(START_CAPTION)
COMMUNITY_LINK = str(-1002083898719)
OWNER_LINK = 'https://t.me/@Naruto_of_telegram'
